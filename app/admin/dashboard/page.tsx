...
export default async function DashboardPage() {
  ...
  // 2. Fetch Semua Data secara Paralel
                      ...
                      return (
                        <tr key={session.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4">
                            <div className="text-sm font-medium text-gray-900">{subject?.name || 'Unknown Subject'}</div>
                            <div className="text-sm text-gray-500">{mod?.name || 'Unknown Module'}</div>
                          </td>
